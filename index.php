...
.masthead:before{
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="assets/img/lga.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="assets/img/lga.png">
    <link rel="apple-touch-icon-precomposed" href="assets/img/lga.png">
    <link rel="shortcut icon" href="assets/img/lga.png">
                ...
                <div class="col-md-12 mb-2 justify-content-center">
                  <form action="" id="find-car">
                    ...
                    <div class="form-group ">
                      <center>
                        <button class="btn btn-dark">Find a car</button>
                      </center>
                    </div>
                  </form>
                </div>                        
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2022- <?php echo $_SESSION['system']['name'] ?> || <a href="admin/">Admin Login</a></div></div>
        </footer>
